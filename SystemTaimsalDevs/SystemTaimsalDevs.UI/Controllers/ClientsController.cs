...
namespace SystemTaimsalDevs.UI.Controllers
{
    ...
    {
        private readonly SystemTaimsalDevsContext _context;

        public ClientsController(SystemTaimsalDevsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Clients != null ? 
                          ...
                          Problem("Entity set 'SystemTaimsalDevsContext.Clients'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SystemTaimsalDevsContext.Clients'  is null.");
            }
            var client = await _context.Clients.FindAsync(id);
            if (client != null)
            {
