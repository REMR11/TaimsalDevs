...
namespace SystemTaimsalDevs.UI.Controllers
{
    public class ReportController : Controller
    {
        ...
        {
            var systemTaimsalDevsContext = _context.Reports.Include(r => r.IdClientNavigation).Include(r => r.IdMachineNavigation).Include(r => r.IdProductNavigation).Include(r => r.IdProviderNavigation).Include(r => r.IdUserNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var report = await _context.Reports
                ...
                .Include(r => r.IdMachineNavigation)
                .Include(r => r.IdProductNavigation)
                .Include(r => r.IdProviderNavigation)
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SystemTaimsalDevsContext.Reports'  is null.");
            }
            var report = await _context.Reports.FindAsync(id);
            if (report != null)
            {
        ...
        {
          return (_context.Reports?.Any(e => e.IdReport == id)).GetValueOrDefault();
        }
    }
}
