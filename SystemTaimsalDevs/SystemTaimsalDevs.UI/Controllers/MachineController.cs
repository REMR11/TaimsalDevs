    ...
    public class MachineController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Machines != null ? 
                          ...
                          Problem("Entity set 'SystemTaimsalDevsContext.Machines'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SystemTaimsalDevsContext.Machines'  is null.");
            }
            var machine = await _context.Machines.FindAsync(id);
            if (machine != null)
            {
        ...
        {
          return (_context.Machines?.Any(e => e.IdMachine == id)).GetValueOrDefault();
        }
    }
}
